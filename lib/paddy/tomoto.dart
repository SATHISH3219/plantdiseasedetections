...
class tomotos extends StatelessWidget {
  final String itemText;

  const tomotos({required this.itemText});
  @override
...
class _MyHomePageState extends State<Brain_tumor> {
  ...
  Future<void> _tfLteInit() async {
    String? res = await Tflite.loadModel(
        model: "assets/paddy_crop.tflite",
        labels: "assets/labelsp.txt",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        shadowColor: Color.fromARGB(255, 0, 38, 255),
            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                    ...
                    elevation: 10,
                    backgroundColor: Color.fromARGB(255, 35, 255, 141),
